...
deriving instance Eq (AddressMixin Identity)
...
deriving instance Eq AlbumId
deriving instance Show AlbumId
deriving instance Eq (PrimaryKey AlbumT (Nullable Identity))
...
deriving instance Eq (PrimaryKey EmployeeT (Nullable Identity))
...
deriving instance Eq GenreId
deriving instance Show GenreId
deriving instance Eq (PrimaryKey GenreT (Nullable Identity))
...
deriving instance Eq InvoiceId
...
deriving instance Eq InvoiceLine
...
deriving instance Eq InvoiceLineId
...
deriving instance Eq MediaTypeId
...
deriving instance Eq PlaylistId
...
deriving instance Eq PlaylistTrack
...
deriving instance Eq PlaylistTrackId
...
addressFields :: String -> AddressMixin (FieldModification (TableField t))
...
chinookDb =
  ...
  (dbModification
   ...
   , customer = setEntityName "Customer" <>
                modifyTableFields (Customer "CustomerId"
                                            "FirstName"
                                            "LastName"
                                            "Company"
                                            (addressFields "")
   ...
   , employee = setEntityName "Employee" <>
                modifyTableFields (Employee "EmployeeId"
                                            "LastName"
                                            "FirstName"
                                            "Title"
   ...
   , genre = setEntityName "Genre" <>
             modifyTableFields (Genre "GenreId" "Name")
   , invoice = setEntityName "Invoice" <>
               modifyTableFields (Invoice "InvoiceId"
                                          (CustomerId "CustomerId")
                                          "InvoiceDate"
                                          (addressFields "Billing")
                                          "Total")
   , invoiceLine = setEntityName "InvoiceLine" <>
                   modifyTableFields (InvoiceLine "InvoiceLineId"
                                                  (InvoiceId "InvoiceId")
                                                  (TrackId "TrackId")
                                                  "UnitPrice"
                                                  "Quantity")
   ...
   , track = setEntityName "Track" <>
             modifyTableFields (Track "TrackId"
                                      "Name"
                                      (AlbumId "AlbumId")
